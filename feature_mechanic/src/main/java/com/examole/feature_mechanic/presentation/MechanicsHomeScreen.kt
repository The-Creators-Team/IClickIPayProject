...
@Composable
fun MechanicsHomeScreen(
    navController: NavController,
    moverViewModel: MechanicsViewModel,
...
//                .background(MaterialTheme.colorScheme.surface)
            ...
            Icon(modifier = Modifier
                .clickable { navController.navigate(MechanicsScreenRoutes.MechanicFilterScreen.route) },
